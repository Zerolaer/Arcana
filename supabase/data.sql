...
-- Character Classes
INSERT INTO character_classes (name, description, base_strength, base_dexterity, base_intelligence, base_vitality, base_energy, base_luck, strength_per_level, dexterity_per_level, intelligence_per_level, vitality_per_level, energy_per_level, luck_per_level, starting_skills, icon, primary_stat) VALUES

('Воин', 'Мастер ближнего боя с мощной защитой и высоким уроном. Специализируется на физических атаках и выносливости.', 20, 10, 5, 18, 8, 12, 2.5, 1.0, 0.5, 2.0, 1.0, 1.0, '{}', '⚔️', 'strength'),

('Лучник', 'Быстрый и точный боец дальнего боя. Высокая скорость атаки и критический урон.', 12, 20, 8, 12, 10, 15, 1.5, 2.5, 1.0, 1.5, 1.0, 1.5, '{}', '🏹', 'dexterity'),

('Маг', 'Мастер магических искусств с разрушительными заклинаниями и высоким магическим уроном.', 6, 8, 22, 10, 20, 10, 0.5, 1.0, 3.0, 1.0, 2.5, 1.0, '{}', '🔮', 'intelligence'),

('Паладин', 'Святой воин, сочетающий боевые навыки с лечебной магией. Высокая защита и поддержка.', 16, 8, 12, 20, 15, 8, 2.0, 1.0, 1.5, 2.5, 1.8, 0.8, '{}', '🛡️', 'vitality'),

('Убийца', 'Мастер скрытности и критических ударов. Высокая скорость и шанс критического урона.', 14, 18, 10, 12, 12, 18, 1.8, 2.2, 1.2, 1.5, 1.2, 2.0, '{}', '🗡️', 'dexterity'),

('Некромант', 'Темный маг, контролирующий смерть и тьму. Высокий магический урон и особые заклинания.', 8, 10, 20, 14, 18, 12, 1.0, 1.2, 2.8, 1.8, 2.2, 1.5, '{}', '💀', 'intelligence'),

('Берсерк', 'Дикий воин, жертвующий защитой ради огромного урона. Высокая скорость атаки.', 22, 16, 4, 16, 6, 14, 3.0, 2.0, 0.3, 2.0, 0.8, 1.8, '{}', '🪓', 'strength'),

('Друид', 'Мастер природной магии и трансформаций. Универсальный класс с лечением и уроном.', 12, 12, 16, 16, 16, 12, 1.5, 1.5, 2.0, 2.0, 2.0, 1.2, '{}', '🌿', 'intelligence'),

('Монах', 'Боец ближнего боя без оружия. Высокая скорость и уникальные комбо-атаки.', 16, 18, 12, 14, 14, 14, 2.2, 2.5, 1.5, 1.8, 1.8, 1.8, '{}', '👊', 'dexterity'),

('Варлок', 'Темный маг, заключивший сделку с демонами. Высокий урон за счет здоровья.', 10, 12, 18, 12, 22, 8, 1.2, 1.5, 2.5, 1.2, 3.0, 1.0, '{}', '🔥', 'energy'),

('Рыцарь Смерти', 'Падший воин, использующий темную магию. Сочетание физического и магического урона.', 18, 10, 14, 16, 16, 8, 2.2, 1.2, 2.0, 2.0, 2.0, 1.0, '{}', '⚰️', 'strength'),

('Следопыт', 'Мастер выживания и охоты. Сочетает дальний бой с магией природы.', 14, 16, 12, 14, 14, 16, 1.8, 2.0, 1.5, 1.8, 1.8, 2.0, '{}', '🦅', 'dexterity');
