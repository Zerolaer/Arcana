-- Чистые функции для системы навыков
-- БЕЗ обращения к несуществующим колонкам

-- 1. Функция изучения активного навыка
...
-- 2. Функция получения активных навыков персонажа
...
-- 3. Функция получения пассивных навыков персонажа
...
SELECT '✅ ЧИСТЫЕ ФУНКЦИИ СОЗДАНЫ!' as result;
