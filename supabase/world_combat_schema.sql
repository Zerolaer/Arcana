...
-- Зеленые Поля (1-5)
('Лесной Слизень', 'Мирное желеобразное существо', 1, 50, 8, 2, 25, 10, '🟢', 'common', 'monster', 'slime.png'),
('Дикий Кролик', 'Быстрый пушистый зверек', 2, 60, 12, 3, 35, 15, '🐰', 'common', 'beast', 'rabbit.png'),
('Молодой Волк', 'Неопытный хищник', 3, 80, 15, 5, 50, 20, '🐺', 'common', 'beast', 'wolf.png'),
('Гигантский Паук', 'Ядовитый паук размером с собаку', 4, 100, 18, 6, 65, 25, '🕷️', 'uncommon', 'monster', 'spider.png'),
('Лесной Страж', 'Древесный голем-защитник', 5, 150, 22, 12, 85, 35, '🌳', 'uncommon', 'elemental', 'treant.png'),

-- Темный Лес (6-10)
('Теневой Волк', 'Волк, пропитанный темной магией', 6, 180, 25, 8, 110, 45, '🐺', 'uncommon', 'beast', 'shadow_wolf.png'),
('Злобный Орк', 'Агрессивный зеленокожий воин', 7, 220, 30, 10, 135, 55, '👹', 'common', 'monster', 'orc.png'),
('Лесная Ведьма', 'Колдунья, живущая в чаще', 8, 200, 35, 12, 160, 65, '🧙‍♀️', 'rare', 'monster', 'witch.png'),
('Древний Ent', 'Могучее дерево-воин', 9, 300, 28, 20, 185, 75, '🌲', 'rare', 'elemental', 'ent.png'),
('Король Медведь', 'Огромный медведь-альфа', 10, 400, 40, 15, 220, 90, '🐻', 'rare', 'beast', 'bear_king.png'),

-- Горные Тропы (11-15)
('Горный Тролль', 'Массивный каменный великан', 11, 500, 45, 25, 260, 110, '👹', 'uncommon', 'monster', 'troll.png'),
('Ледяной Элементаль', 'Существо из льда и снега', 12, 450, 50, 20, 300, 130, '❄️', 'rare', 'elemental', 'ice_elemental.png'),
('Грифон', 'Гордая птица с телом льва', 13, 400, 60, 18, 340, 150, '🦅', 'rare', 'beast', 'griffin.png'),
('Каменный Голем', 'Ожившая скала', 14, 600, 55, 35, 380, 170, '🗿', 'rare', 'elemental', 'stone_golem.png'),
('Драконенок', 'Молодой дракон', 15, 550, 70, 25, 450, 200, '🐉', 'epic', 'monster', 'dragon_young.png'),

-- Заброшенные Руины (16-20)
('Скелет-Воин', 'Ожившие останки древнего воина', 16, 400, 65, 30, 500, 220, '💀', 'common', 'undead', 'skeleton_warrior.png'),
('Призрак', 'Душа, не нашедшая покоя', 17, 350, 75, 15, 550, 240, '👻', 'uncommon', 'undead', 'ghost.png'),
('Мумия', 'Забальзамированный древний правитель', 18, 650, 70, 40, 600, 260, '🧟‍♂️', 'rare', 'undead', 'mummy.png'),
('Лич', 'Могущественный маг-нежить', 19, 500, 90, 35, 700, 300, '☠️', 'epic', 'undead', 'lich.png'),
('Древний Дракон', 'Старый и мудрый дракон', 20, 800, 100, 45, 850, 400, '🐲', 'legendary', 'monster', 'ancient_dragon.png')
ON CONFLICT DO NOTHING;
