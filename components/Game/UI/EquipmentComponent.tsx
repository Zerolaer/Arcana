...
const CLASS_NAMES: Record<string, string> = {
  // Из complete_classes_overhaul.sql (только 4 новых класса)
  'archer': 'Лучник',
  'mage': 'Маг', 
  'berserker': 'Берсерк',
  'assassin': 'Ассасин'
...
// Соответствует классам из complete_classes_overhaul.sql (только 4 новых класса)
const CLASS_AVATARS: Record<string, { emoji: string; image?: string }> = {
  'Лучник': { emoji: '🏹', image: '/avatars/archer.png' },
  'Маг': { emoji: '🔮', image: '/avatars/mage.png' },
  'Берсерк': { emoji: '🪓', image: '/avatars/berserker.png' },
  'Ассасин': { emoji: '🗡️', image: '/avatars/rogue.png' }
}
